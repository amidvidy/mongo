...
const tcp::endpoint endpoint{tcp::v4(), 28888};
...
class AsyncStreamTest : public mongo::unittest::Test {
public:
    virtual ~AsyncStreamTest() = default;
...
TEST(AsyncStreamTest, IsOpen) {
    ...
    executor::AsyncStream stream{&io_service};
