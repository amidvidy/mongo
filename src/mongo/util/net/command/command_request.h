...
namespace mongo {
    ...
    // An immutable view of an OP_COMMAND message. Underlying message MUST outlive
    // the CommandRequest.
    class CommandRequest {
    public:
        // Construct a CommandRequest from a Message.
        // Fields will be parsed eagerly.
        ...
        //const std::vector<BSONObj>& getInputDocuments() const;
